...
<div align="center">
  ...
  <h3><b>portoflio mobile-first project</b></h3>
...
> this portoflio mobile-first project i have created using HTML, CSS, linters
...
```sh
  cd my-folder
  git clone https://github.com/MohamedRoshdy2021/mobile_first_task
```
